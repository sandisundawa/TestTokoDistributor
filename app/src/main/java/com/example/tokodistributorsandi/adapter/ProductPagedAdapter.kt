...
class ProductPagedAdapter (private val context: Context) : PagedListAdapter<Product, RecyclerView.ViewHolder>(
    ProductDiffCallback()
) {
    ...
    class ProductItemViewHolder (view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(product: Product?, context: Context) {
            itemView.tv_title.text = product?.productName
            itemView.tv_price.text = "Rp." + product?.normalPrice.toString()
